        ...
        <header data-thq="thq-navbar" className="navbarContainer home-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav bodySmall" onClick={() => navigate('/C')}>Service</span>
            ...
            <div className="home-buttons">
              <button className="home-login buttonFlat" onClick={() => navigate('/login')}>
                Login
              </button>
              <button className="home-register buttonFilled" onClick={() => navigate('/signup')}>
                Register
              </button>
            </div>
          </div>
